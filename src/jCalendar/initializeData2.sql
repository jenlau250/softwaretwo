...
INSERT INTO customerpets (customerpetsId, customerId, petId, createDate, createdBy, lastUpdate, lastUpdateBy)
     VALUES (NULL, @customer_id, @pet_id, CURRENT_TIMESTAMP, 'test', CURRENT_TIMESTAMP, 'test'
     );
SET @customerpets_id = LAST_INSERT_ID();
...
INSERT INTO appointment (appointmentId, title, start, end, description, type, location, month, createDate, createdBy, lastUpdate, lastUpdateBy, customerpetsId, barberId)
     VALUES (NULL, 'Standard Appt', '2020-01-11 15:00:00', '2020-01-11 15:00:30', 'Description', 'Full Service', 'location', 'January', 
     CURRENT_TIMESTAMP, 'test', CURRENT_TIMESTAMP, 'test',
     @customerpets_id, @barber_id);   # use ID in second table
